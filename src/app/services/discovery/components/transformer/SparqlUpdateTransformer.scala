...
class SparqlUpdateTransformer(override val iri: String, query: UpdateQuery, features: Seq[Feature], override val label: String) extends SparqlUpdateTransformerInstance with DescriptorChecker {
