...
class JenaDataSource(override val iri: String, model: Model, val label: String = "", val isLarge: Boolean = false, val isLinkset: Boolean = false) extends DataSourceInstance {
